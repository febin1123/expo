{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "chips=pd.read_table('https://raw.githubusercontent.com/justmarkham/pandas-videos/master/data/chipotle.tsv')"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "col_name=['id','age','gender','designation','zipcode']\n",
    "musers=pd.read_table('https://raw.githubusercontent.com/justmarkham/pandas-videos/master/data/u.user',sep='|',names=col_name)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "   id  age gender designation zipcode\n",
  ...
  },
  {
   ...
   "source": [
    "pd.read_table('https://raw.githubusercontent.com/justmarkham/pandas-videos/master/data/u.user')"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "musers['id_age']=musers['id']+musers['age']"
   ]
  },
  {
   "cell_type": "code",
